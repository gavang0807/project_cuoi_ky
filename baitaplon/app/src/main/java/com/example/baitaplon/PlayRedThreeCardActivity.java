...
public class PlayRedThreeCardActivity extends AppCompatActivity {
    private TextView tv_Ten_Red;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_red_three_card);
        initView();
        setTenDo();
        setLatBai();
        setChoiLai();
    ...
    private void setThoat() {
        bt_Thoat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PlayRedThreeCardActivity.this, PickSideActivity.class);
                String name = tv_Ten_Red.getText().toString();
...
//                //tinh diem
//                if (diemXanh > diemDo){
//                    Toast.makeText(PlayRedThreeCardActivity.this, "Quân Xanh thắng!", Toast.LENGTH_SHORT).show();
//                } else if (diemXanh == diemDo){
//                    Toast.makeText(PlayRedThreeCardActivity.this, "Hòa", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(PlayRedThreeCardActivity.this, "Quân Đỏ thắng!", Toast.LENGTH_SHORT).show();
//                }
    ...
    private void setTenDo() {
        Intent intent = getIntent();
        String name = intent.getStringExtra(PickSideActivity.NAME);
        tv_Ten_Red.setText(name);
    }

    private void initView() {
        tv_Ten_Red=findViewById(R.id.tv_Ten_Red);
